...
class WebFullCategoryDealsScreen extends StatefulWidget {
  static const String routeName = '/category-deals';
  final String category;
  const WebFullCategoryDealsScreen({
    Key? key,
    required this.category,
  }) : super(key: key);

  @override
  State<WebFullCategoryDealsScreen> createState() =>
      _WebFullCategoryDealsScreenState();
}

class _WebFullCategoryDealsScreenState
    extends State<WebFullCategoryDealsScreen> {
                      ...
                      children: [
                        Container(
                          ...
                          child: headerDoubleText(
                            textHeader: 'Productos web en  ${widget.category}',
                            textAction: '',
                          ),
                        ),
                        productList == null
